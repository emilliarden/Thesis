...
def move_and_delete_files(filename):
    ...
    if os.path.exists("winner.pkl"):
        src_path = "winner.pkl"
        dst_path = r"/Users/emilknudsen/Desktop/research/Statistics/Runs/Less_Food/Unfull_25/TrainedOnFullHalfQuarter/winner" + str(filename) + ".pkl"
        shutil.move(src_path, dst_path)

    # Move stats
    src_path = "fitness_history.csv"
    dst_path = r"/Users/emilknudsen/Desktop/research/Statistics/Runs/Less_Food/Unfull_25/TrainedOnFullHalfQuarter/fitness_history" + str(filename) + ".csv"
    shutil.move(src_path, dst_path)
