...
def move_and_delete_files(filename):
    ...
    if os.path.exists("winner.pkl"):
        src_path = "winner.pkl"
        dst_path = r"/Users/emilknudsen/Desktop/research/Statistics/Function_Distribution/Unfull_15/Direct/winner" + str(filename) + ".pkl"
        shutil.move(src_path, dst_path)

    # Move stats
    src_path = "fitness_history.csv"
    dst_path = r"/Users/emilknudsen/Desktop/research/Statistics/Function_Distribution/Unfull_15/Direct/fitness_history" + str(filename) + ".csv"
    shutil.move(src_path, dst_path)
...
if __name__ == "__main__":
    ...
    food_distribution = FoodDistribution.Unfull_15
    draw = False
