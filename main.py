...
def move_and_delete_files(filename):
    ...
    if os.path.exists("winner.pkl"):
        src_path = "winner.pkl"
        dst_path = r"Statistics/Function_Distribution/Corners/TrainedOnFullHalfQuarter/winner" + str(filename) + ".pkl"
        shutil.move(src_path, dst_path)

    # Move stats
    src_path = "fitness_history.csv"
    dst_path = r"Statistics/Function_Distribution/Corners/TrainedOnFullHalfQuarter/fitness_history" + str(filename) + ".csv"
    shutil.move(src_path, dst_path)
...
if __name__ == "__main__":
    ...
    create_pop_and_find_winner(constants=constants, rounds_to_run=2000, winner_file='/Users/emilknudsen/Desktop/research/Statistics/Function_Distribution/QuarterFull/TrainedOnFullAndHalfFull_new_config/winner5.pkl')
    exit(0)

    for file in glob.glob("Statistics/Function_Distribution/QuarterFull/TrainedOnFullAndHalfFull_new_config/winner*.pkl"):
    #for i in range(10):
